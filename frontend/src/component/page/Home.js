    ...
    <div className="p-2 md:p-4">
      <div className="md:flex gap-4 py-2">
        <div className="md:w-1/2">
          ...
          <button className="font-bold text-white bg-red-500 px-3 py-2 rounded-md">
            Order Now
          </button>
        </div>
      ...
      <div className="">
        <div className="flex w-full items-center">
          ...
          <div className="ml-auto flex gap-4">
            <button
              onClick={prevProduct}
              className="bg-slate-300 hover:bg-slate-400 p-1 text-lg rounded"
            >
              <GrPrevious />
            </button>
            <button
        ...
        <div
          className="flex gap-5 overflow-scroll scrollbar-none scroll-smooth"
          ref={slideProductRef}
        >
